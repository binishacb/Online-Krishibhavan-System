        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- Add Agriculture Officer Card Here -->
                        <?php
                        for ($i = 0; $i < $agricultureOfficerCount; $i++) {
                            ...
                            echo "<div class='d-flex justify-content-between'>
                                <div>$firstname</div>
                                <a href='delete_officer.php?officer_id=$officer_id' class='btn btn-danger btn-sm'>Delete</a>
                            </div>";
                        }
                        if ($agricultureOfficerCount < 1) {
                            echo "Empty Field: <a href='officer_registration.php?designation_name=Agriculture%20Officer' class='btn btn-primary btn-sm'>Add Officer</a><br>";
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($assistantOfficerCount < 2) {
                            echo "Empty Field: <a href='officer_registration.php?designation_name=Assistant%20Officer' class='btn btn-primary btn-sm'>Add Officer</a><br>";
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($marketingOfficerCount == 0) {
                            echo "Empty Field: <a href='officer_registration.php?designation_name=Marketing%20Officer' class='btn btn-primary btn-sm'>Add Officer</a><br>";
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($staffCount < 5) {
                            echo "Empty Field: <a href='officer_registration.php?designation_name=Staffs' class='btn btn-primary btn-sm'>Add Officer</a><br>";
                        }
                        ?>
                    </div>
                </div>
