...
$sql = "SELECT rental_orders.*,r.rp_name FROM rental_orders  JOIN rent_product as r ON rental_orders.rp_id = r.rp_id WHERE rental_id = $order_id";
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p><strong>Order Date:</strong> <?php echo $shipping_data['rental_date']; ?></p>
                    <p><strong>Order ID:</strong> <?php echo $shipping_data['rental_order_id']; ?></p>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td> <?php echo $shipping_data['rp_name']; ?></td>
