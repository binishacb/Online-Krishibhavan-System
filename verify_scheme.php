    ...
    <div class="container">
        <div class="table-responsive">
            <table class="table table-bordered table-striped text-center">
                ...
                <tbody>
                    <?php
                    if (mysqli_num_rows($result_land_tax) > 0) {
                        $row_land_tax = mysqli_fetch_assoc($result_land_tax);
                        echo "<tr>";
                        ...
                        echo "<tr><td colspan='4'>No record found for the provided Land Tax Number.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
...
<form action="scheme_approval.php" method="post">
        ...
        <button type="button" onclick="openRejectModal()" class="btn btn-danger">Reject</button>
    </form>
</body>
</html>
